var webView = {
  ...
  render: function() {
    var imgList = controller.getList('web');
    var galleryId = document.getElementById('webViewer');

    makeThumbs(imgList, galleryId);
  }
};

var makeThumbs = function(imgList, galleryId) {
